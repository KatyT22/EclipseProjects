...
/*
La classe de jeu principale hérite de la classe intégrée Canvas qui contient des fonctionnalités utiles pour créer le jeu, 
tels qu'une liste de touches qui relie les frappes au jeu et fonctionne pour créer la fenêtre de jeu. 
Le jeu implémente également Runnable qui permet de démarrer et d'arrêter des threads.
 */
public class Game extends Canvas implements Runnable {

    public static final int SQUARE = 64;                                                        //Divise le terrain de jeu en carrés, chaque carré est de 64 pixels
    public static final int FACTOR = 10;                                                        //Le terrain de jeu est de 10 carrés de large
    public static final int WIDTH = SQUARE*FACTOR;                                              //La longueur du terrain de jeu est le nombre de carrés*la longueur de chaque carré
